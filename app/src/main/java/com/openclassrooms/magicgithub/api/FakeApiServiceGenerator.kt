...
object FakeApiServiceGenerator {
    ...
    var FAKE_USERS = mutableListOf(
        ...
        User("014", "Laura", "https://upload.wikimedia.org/wikipedia/commons/5/56/Donald_Trump_official_portrait.jpg"),
        User("015", "Gertrude", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStPEZrm1-iMvr9-iBOcyn30txTUalXEGsTBw&s"),
        User("016", "Chloé", "https://upload.wikimedia.org/wikipedia/commons/5/56/Donald_Trump_official_portrait.jpg"),
